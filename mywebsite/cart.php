...
// Check if form is submitted and handle login
...
if (isset($_SESSION['customer_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // echo "<p>Query Debug: No rows returned. Check if there are items in the cart for CustomerID: $customer_id.</p>";
    }

    echo '</div>'; // Close the container div

    $stmt->close();
} else { //incase any errors occured
